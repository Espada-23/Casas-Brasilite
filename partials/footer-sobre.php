...
<footer class="rodape-completo">
    <div class="newsletter">
        <div class="container newsletter-conteudo">
            <div class="texto-news">
                <i class="far fa-envelope"></i>
                <span>Receba ofertas exclusivas e novidades por e-mail</span>
            </div>
    ...
    <div class="container conteudo-rodape">
        ...
        <div class="coluna-rodape">
            <div class="logo">
                <a href="/Casas-Brasilite/index.php"><img src="../../imagens/logo2.png"></a>
            </div>

            <p class="texto-descricao-rodape">
                Materiais de construção com qualidade, segurança e o melhor
    ...
    <div class="rodape-inferior">
        <div class="container">
            <p>&copy; 2026 Casas Brasilite. Todos os direitos reservados.</p>
        </div>
    </div>
</footer>